...
resnet_weights_path = 'C:/Users/ushasi2/Documents/PythonScripts/pretraining/resnet50/resnet50_weights_tf_dim_ordering_tf_kernels_notop_updated.h5'
...
train_generator = data_generator.flow_from_directory(
        'D:/zero_shot/rendered_256x256/256x256/sketch/tx_000000000000',
...
test_generator = data_generator.flow_from_directory(
    directory = 'D:/zero_shot/rendered_256x256/256x256/sketch/tx_000000000000',
    target_size = (image_size, image_size),
...
sio.savemat('sketchmat',mdict={'feature':pred})
